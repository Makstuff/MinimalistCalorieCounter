...
- In the default database there is a food called "Average". This has the recommended nutrient ratios of a healthy, protein-focused diet and is set up such that 100g have exactly 100kcal. So if I estimate based on experience that I maybe ate 700kcal of food I don't know the content of, I just log 700g of the food "Average" and call it good enough.
